                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="content" required rows="4" placeholder="Objectifs, ressources, livrables attendus..."
                                          class="w-full bg-slate-900/50 border border-white/10 rounded-2xl px-5 py-3.5 focus:ring-2 focus:ring-indigo-500 outline-none transition-all placeholder:text-slate-600 whitespace-pre-wrap resize-none">{{ old('content', $brief->content) }}</textarea>
