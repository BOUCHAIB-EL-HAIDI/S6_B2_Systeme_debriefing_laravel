...
<head>
    ...
    <title>Modifier la Classe - Debrief.me</title>
        ...
        <main class="flex-1 ml-64 p-8 flex justify-center">
            <div class="w-full max-w-2xl">
                <header class="mb-10 flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold">Modifier la Classe</h1>
                        <p class="text-slate-400 mt-1">Mettre à jour les informations de la promotion</p>
                    </div>
                </header>
